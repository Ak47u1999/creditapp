...
def inference_call(data_list):
    ...
    response_scoring = requests.post('https://cpd-outcomes-cpd-cpd-outcomes.cp4d-prod-na-04-demo-b9aa1303e037748136e24e1f282ebee9-0000.us-south.containers.appdomain.cloud/ml/v4/deployments/642cfecc-a5bb-4754-81c2-77f4e055e254/predictions?version=2021-11-01', json=payload_scoring, headers=header)
